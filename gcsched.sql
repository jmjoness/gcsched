...
insert into block (blkdate, duration, starttime, numblocks) values ("2023-09-09", 10, 600, 24);
insert into block (blkdate, duration, starttime, numblocks) values ("2023-09-10", 10, 840, 24);
