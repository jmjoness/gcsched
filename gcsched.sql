...
insert into block (blkdate, duration, starttime, numblocks) values ("2023-09-09", 15, 600, 24);
insert into block (blkdate, duration, starttime, numblocks) values ("2023-09-10", 15, 840, 24);
